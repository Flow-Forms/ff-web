...
- What you searched for isn't highlighted anywhere on the presented submission results. This is probably because your *Display* option is set to "Collapse All" and the form element that matches your search is only visible in expanded view. Select the "Expand All" display option from the submissions management panel, or click "show more" in the individual submission's header.
